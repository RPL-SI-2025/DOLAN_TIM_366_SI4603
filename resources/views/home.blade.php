...
<body class="text-gray-800">
  ...
  <div class="w-full flex justify-center pt-6">
    <div class="bg-white glass rounded-full px-10 py-4 flex items-center justify-between shadow-lg max-w-3xl w-full">
      ...
      <nav class="hidden md:flex gap-6 text-gray-800 font-medium">
        ...
        <a href="#tours" class="hover:text-purple-600">Tours</a>
      ...
      <a href="#" class="ml-4 bg-purple-600 text-white px-5 py-2 rounded-full hover:bg-purple-700 transition">
        Sign In
      </a>
    </div>
  </div>
  ...
  <script>
    $(document).ready(function() {
      ...
      function loadDestinations() {
        $.ajax({
          ...
          success: function(data) {
            ...
            // Menambahkan card ke dalam kontainer
      ...
      // Atur interval untuk mengambil data baru setiap 10 detik
